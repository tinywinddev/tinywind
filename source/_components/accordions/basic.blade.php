<div x-data="accordion" class="max-w-md border border-gray-200 divide-y divide-gray-200">
    <h3 class="text-lg">
        <button x-bind="header('general')" class="flex items-center justify-between w-full px-4 py-2 font-medium focus:outline-black">
            <span>General</span>
    ...
    <h3 class="text-lg">
        <button x-bind="header('settings')" class="flex items-center justify-between w-full px-4 py-2 font-medium focus:outline-black">
            <span>Settings</span>
            <!-- Active: `transform rotate-180`, Inactive: `transform rotate-0` -->
